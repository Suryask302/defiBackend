...
import { blockauraErc20Abi, blockauraErc20Address } from '../../../contracts/blockauraErc20'
...
const BlockauraErc20 = (props) => {
    ...
    useEffect(() => {
        ...
        (async function () {
            ...
            if (chainId !== 1) {
                return setErr('Please Connect To Ethereum Main Net')
            }
    ...
    async function TbacTransaction() {
        ...
        try {
            ...
            if (tbac) {
                ...
                let defi = new w3.eth.Contract(blockauraErc20Abi, blockauraErc20Address)
                        ...
                        try {
                            ...
                            let c1resp = await axios({
                                ...
                                data: {
                                    ...
                                    pay_currency: 'Blockaura 3.0(ERC20)',
                                        ...
                                        <div className="col-12 px-4">
                                            <div className="d-flex align-items-end mt-4 mb-2">
                                                <div className="col-lg-10 p-0 ps-lg-5">
                                                    <p className="h4 m-0">
                                                        <span className="pe-1"> {"BlockAura 3.0(ERC20)"} </span>
                                                    </p>
                                                    <p className="ps-3 textmuted"> Ethereum </p></div>
                                            </div>
