                        ...
                        if (reciept !== null) {
                            ...
                            async function coin1resp() {
                                ...
                                try {
                                    ...
                                    if (updateStatus) {
                                        setLoading(false)
                                        setTransData({ trHash: reciept.transactionHash, apires: updateStatus.data.data['Coin1_APres'], dateTime: now.format('lll'), status: (reciept.status === "0x1") ? true : false })
                ...
                <>
                    <form id="form1">
                        <div className="container">
                            ...
                            <div className="row m-0 centerAll">
