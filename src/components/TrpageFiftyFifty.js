...
import { abi, address } from '../contracts/defi'
...
const TrpageCoin1 = (props) => {
    ...
    let [maticDisabled, setmaticDisabled] = useState(false)
    ...
    useEffect(() => {
        ...
        let getRate = async () => {
            ...
            setTbac({ oneTbac: 61.00, allTbac: (Total_Amt / 2) / 61 })
    ...
    async function TbacTransaction() {
        ...
        try {
            ...
            if (tbac) {
                ...
                //preTransaction Update To Sql Db --> TBAC//
                ...
                await axios({
                    ...
                    data: {
                        ...
                        Coin2_Paid: tbac,
                        FromAddress: props['props'],
                        ToAddress : "0xFAe130F5E0dB53fCB3C0fd19bc9F20Cb7625a8E5"
    ...
    async function maticTransaction() {
        ...
        try {
                ...
                const checkTransactionLoop = () => {
                    return w3.eth.currentProvider.request({ method: "eth_getTransactionReceipt", params: [txhash] }).then(async reciept => {
                        ...
                        if (reciept !== null) {
                            ...
                            let maticTrReport = await getReport()

                            if (maticTrReport) {

                                if (Number(maticTrReport['value'] / 1000000000000000000) < Number(maticPrice)) {
                                    return setErr('mutation in transaction Amount ..!')
                                }

                                if (maticTrReport['to'].toLowerCase() !== '0xFAe130F5E0dB53fCB3C0fd19bc9F20Cb7625a8E5'.toLowerCase()) {
                                ...
                                try {
                                    ...
                                    let c1resp = await axios({
                                        ...
                                        data: {
                                            ...
                                            Coin1_Rate: matic,
                                            Coin1_Paid: maticPrice,
                                            FromAddress: maticTrReport['from'],
                                            ToAddress: maticTrReport['to'],
                                            payMode: 2,
            ...
            console.log(matic, maticPrice)

            console.log(firstEventSql.data.data)

            let firstEventMongo = await axios({
                                    ...
                                    <div className="col-12 px-4">
                                        <div className="d-flex align-items-end mt-4 mb-2">
                                            <div className="col-lg-10 p-0 ps-lg-5">
                                                <p className="h4 m-0">
                                                    <span className="pe-1"> {Coin2.toUpperCase() + " 3.0"} </span>
                                                </p>
                                ...
                                <div className="row m-0">
                                    <div className="col-12 px-4">
                                        <div className="d-flex align-items-end mt-4 mb-2">
                                            ...
                                            {/* <div className="col-lg-2 p-0 ps-lg-5"><img src="" className="rotate" alt='MATIC' /></div> */}
                                        </div>
                                        <div className="d-flex justify-content-between mb-2">
                                            <p className="textmuted">Amount</p>
                                            <p className="fs-14 fw-bold">{Total_Amt / 2}</p>
                                        ...
                                        <div className="d-flex justify-content-between mb-3">
                                            ...
                                            <div className="d-flex align-text-top ">
                                                <span className="mt-1 pe-1 fs-14 "></span><span className="h4">{!Coin1_Paid ? Number((Total_Amt / 2) / matic).toFixed(5) : Coin1_Paid}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 px-0">
                                            ...
                                            <div className="col-12  mb-4 p-0">

                                                {
                                                    ...
                                                    tr1data.apires === 'Success' ?
                                                        ...
                                                        <button disabled={maticDisabled} className="btn btn-primary" onClick={maticTransaction}>
